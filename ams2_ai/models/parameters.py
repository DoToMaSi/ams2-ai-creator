...
PARAMETERS: list[ParameterDef] = [
    ...
    ParameterDef(
        ...
        ParamKind.SCALAR,
        "Vehicle Performance",
        "Multiplies vehicle mass (0.900-1.100). Also affects player if using this livery.",
        ui_min=90,
        ui_max=110,
        xml_min=0.900,
        xml_max=1.100,
    ...
    ParameterDef(
        ...
        ParamKind.SCALAR,
        "Vehicle Performance",
        "Multiplies engine power (0.900-1.100). Also affects player if using this livery.",
        ui_min=90,
        ui_max=110,
        xml_min=0.900,
        xml_max=1.100,
    ...
    ParameterDef(
        ...
        ParamKind.SCALAR,
        "Vehicle Performance",
        "Multiplies aerodynamic drag (0.900-1.100). Also affects player if using this livery.",
        ui_min=90,
        ui_max=110,
        xml_min=0.900,
        xml_max=1.100,
    ...
    ParameterDef(
        ...
        ParamKind.UNIT,
        "Setup",
        "Preferred downforce bias. 50 (0.5) is neutral; below favors low DF, above favors high DF.",
    ),
    ParameterDef(
        ...
        ParamKind.UNIT,
        "Setup",
        "How much setup varies between race weekends from the preferred downforce value.",
    ),
    ParameterDef(
        "vehicle_reliability",
        "Vehicle Reliability",
