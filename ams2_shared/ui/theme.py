...
from ams2_shared.util.assets import font_paths, icon_ico_path, icon_png_path, stylesheet_path

logger = logging.getLogger("ams2.ui.theme")
...
MARGINS_DIALOG = (SPACING_SECTION, SPACING_SECTION, SPACING_SECTION, SPACING_SECTION)
MARGINS_HEADER = (SPACING_SECTION, SPACING_INNER, SPACING_SECTION, SPACING_INNER)
